                ...
                <div class="card-header">{{ __('Sanitation Facilities in Public Places - Basic') }}</div>
                    ...
                    <form action="table6" method="post" enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" name="form6_id11" placeholder="Block Name..">
                            </div>

                            <div class="form-group col-md-4">
                                <label for="inputnoofhamlets">Total No.of Hamlets</label>
                                <input type="number" min="0"  class="form-control" name="form6_id2" placeholder="Count..">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="form6_id">Total No.of Schools</label>
                                <input type="number" min="0"  class="form-control" name="form6_id3" placeholder="Count..">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="form6_id">Toilet Facility Provided Schools</label>
                                <input type="number" min="0"  class="form-control" name="form6_id4" placeholder="Count..">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="form6_id">Total No.of Anganwadi Centers</label>
                                <input type="number" min="0"  class="form-control" name="form6_id5" placeholder="Count..">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="form6_id">Toilet Facility Provided Anganwadi Centers</label>
                                <input type="number" min="0"  class="form-control" name="form6_id6" placeholder="Count..">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="form6_id">Total No.of Government Offices</label>
                                <input type="number" min="0"  class="form-control" name="form6_id7" placeholder="Count..">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="form6_id">Toilet Facility Provided Government Offices</label>
                                <input type="number" min="0"  class="form-control" name="form6_id8" placeholder="Count..">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="form6_id">Other Public Places</label>
                                <input type="number" min="0"  class="form-control" name="form6_id9" placeholder="Count..">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="form6_id">Toilet Facility Provided Other Public Places</label>
                                <input type="number" min="0"  class="form-control" name="form6_id10" placeholder="Count..">
                            </div>
